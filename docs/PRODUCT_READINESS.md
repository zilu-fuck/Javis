...
1. Harden the live DeepSeek-compatible opencode provider path so it returns a
   parseable JSON patch proposal, then rerun the Code Agent live approval QA.
