...
1. Migrate Code Patch approval to the durable approval record and add proposal
   base/dry-run/hash checks before apply.
2. Refactor PDF and Code Patch native checks into reusable approval/path/hash
   guards.
