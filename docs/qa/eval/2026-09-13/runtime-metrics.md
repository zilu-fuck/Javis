...
- generated: 2026-09-13T03:27:35.932Z
...
| table | MB |
| --- | --- |
| task_session_log | 5.6 |
| workflow_checkpoints | 3.2 |
| runtime_events | 1.7 |
| file_scan_cache | 0.9 |
| file_classifications | 0.7 |
| sqlite_autoindex_file_classifications_1 | 0.5 |
| sqlite_autoindex_file_scan_cache_1 | 0.5 |
| tool_call_audit | 0.1 |
| sqlite_autoindex_runtime_events_1 | 0.1 |
| sqlite_autoindex_runtime_events_2 | 0.1 |
| idx_runtime_events_run_sequence | 0.1 |
| memory_injection_logs | 0.1 |
