...
export const zhCNWorkbenchLocale: WorkbenchLocale = {
  ...
  labels: {
    ...
    denyPermission: "拒绝",
    fullAccess: "请求完全访问",
    requestApproval: "请求授权",
    approvalRequested: "已请求授权",
    commandResults: "只读命令",
    commander: "指挥官",
    codeReview: "代码审查",
    changedFiles: "已变更文件",
    ...
    scheduledTaskGoal: "任务目标",
    scheduledTaskScheduleType: "调度类型",
    scheduledTaskScheduleValue: "调度值",
    scheduledTaskDaily: "每日",
    scheduledTaskWeekly: "每周",
    scheduledTaskInterval: "间隔",
    scheduledTaskOnce: "一次",
...
export const defaultWorkbenchLocale: WorkbenchLocale = {
  ...
  labels: {
    ...
    scheduledTaskGoal: "Task goal",
    scheduledTaskScheduleType: "Schedule type",
    scheduledTaskScheduleValue: "Schedule value",
    ...
    trustedComputerApps: "Task-allowed Apps",
